  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans text-left relative">
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden">
        ...
        {/* 🟡 FIRST DIV: Header Section with Close Button */}
        <div className="p-6 md:p-8 border-b border-slate-150 relative bg-slate-50/50">
          <button
            onClick={() => navigate('/dashboard')} // 👈 ক্লোজ বাটনে ক্লিক করলে ড্যাশবোর্ডে যাবে
            className="absolute top-6 right-6 text-slate-400 hover:text-slate-700 hover:bg-slate-200/60 w-8 h-8 rounded-full flex items-center justify-center transition text-lg font-bold"
            title="Close Profile"
          >
            ✕
          </button>
          <h1 className="text-2xl font-bold text-slate-800 pr-8">Applicant Profile</h1>
