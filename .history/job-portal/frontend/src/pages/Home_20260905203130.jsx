  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-left pb-12">
      ...
      <div className="bg-gradient-to-r from-purple-900 via-indigo-900 to-purple-900 text-white py-14 px-4 sm:px-8 mb-8 relative overflow-hidden">
        ...
        {/* 🔴 X-Marked Area: Top-Right Navigation Buttons */}
        <div className="absolute top-4 right-4 sm:top-6 sm:right-8 z-20 flex items-center gap-2.5">
          {user ? (
            <>
              <Link
                to="/dashboard"
        ...
        <div className="max-w-4xl mx-auto relative z-10 space-y-3 text-center">
