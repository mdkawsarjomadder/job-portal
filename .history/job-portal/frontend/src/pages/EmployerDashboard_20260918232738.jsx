  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 text-left font-sans relative">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-purple-900 via-indigo-800 to-purple-900 text-white p-4 rounded-2xl shadow-lg flex flex-col sm:flex-row justify-between items-center sm:items-center gap-6">
