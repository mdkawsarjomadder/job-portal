...
export default function EmployerDashboard() {
  ...
  <table className="w-full text-left border-collapse min-w-[700px]">
    {/* Clean, Modern & Beautiful Table Header */}
    <thead>
      <tr className="bg-gradient-to-r from-purple-700 to-indigo-700 text-white text-[11px] font-bold uppercase tracking-wider">
        <th className="py-3.5 px-4 rounded-tl-xl">Applicant</th>
        ...
        return (
          <tr key={appId} className="hover:bg-slate-50/80 transition-colors">
            ...
            <td className="py-4 px-4">
              {app.interviewDate ? (
                <div className="flex flex-col text-[11px] text-indigo-700 bg-indigo-50/80 border border-indigo-100 p-2 rounded-lg max-w-[180px]">
              ...
              <div className="flex items-center justify-end gap-1.5">
                {app.status === 'SHORTLISTED' && (
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-[11px] font-medium rounded-lg transition shadow-sm flex items-center gap-1"
                  >
                    {app.interviewDate ? '🔄 Edit' : '✉️ Interview SMS'}
                  </button>
                )}
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-40 disabled:cursor-not-allowed text-white text-[11px] font-medium rounded-lg transition shadow-sm"
                >
                  Shortlist
                </button>
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 bg-rose-500 hover:bg-rose-600 disabled:opacity-40 disabled:cursor-not-allowed text-white text-[11px] font-medium rounded-lg transition shadow-sm"
                >
                  Reject
                </button>
              </div>
