        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-sm">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-purple-600 focus:bg-white transition"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-slate-100 border border-slate-200 rounded-xl text-slate-400 cursor-not-allowed"
            />
          </div>
