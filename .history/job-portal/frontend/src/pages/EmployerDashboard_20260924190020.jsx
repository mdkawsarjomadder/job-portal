      ...
      {job.applications?.map((app) => {
        ...
        return (
          <tr key={appId} className="hover:bg-slate-50/80 transition-colors">
            ...
            {/* 6. ACTIONS (Dropdown Option Style) */}
            <td className="py-3.5 px-4 text-center whitespace-nowrap">
              <div className="flex items-center justify-center gap-2">
                <select
                  ...
                  className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer transition-all"
                >
