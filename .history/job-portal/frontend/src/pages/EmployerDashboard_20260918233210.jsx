    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-6 text-left font-sans relative">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
          ...
          <div className="w-14 h-14 bg-white/10 backdrop-blur-md text-white border border-white/20 font-bold text-2xl rounded-2xl flex items-center justify-center uppercase shadow-inner">
