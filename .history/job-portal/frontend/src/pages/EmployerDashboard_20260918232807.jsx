  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 text-left font-sans relative">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-purple-900 via-indigo-800 to-purple-500 text-white p-6 rounded-2xl shadow-lg flex flex-col sm:flex-row justify-between items-center sm:items-center gap-6">
          
         {/* Left Section: Vertically Stacked Profile Info with Tighter Spacing */}
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
          
          {/* 1. Profile Image / Avatar */}
          <div className="w-14 h-14 bg-white/10 backdrop-blur-md text-white border border-white/20 font-bold text-2xl rounded-2xl flex items-center justify-center uppercase shadow-inner shrink-0 mb-1.5">
