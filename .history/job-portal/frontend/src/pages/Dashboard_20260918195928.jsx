      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-3 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-full transition focus:outline-none"
          >
            {/* Name on Left */}
            ...
            {/* Avatar Image/Letter on Right */}
            <div className="w-8 h-8 rounded-full bg-purple-600 text-white font-extrabold text-xs flex items-center justify-center border-2 border-white shadow-sm overflow-hidden shrink-0">
              {user.avatar ? (
