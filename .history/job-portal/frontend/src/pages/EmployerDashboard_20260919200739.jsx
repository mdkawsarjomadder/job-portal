...
// Submit Interview & Send SMS
  const handleSendInterviewCall = async (e) => {
    ...
    // Formatting custom SMS message (No "Call", only Interview details & Date)
    ...
    try {
      const payload = {
        ...
        message: smsMessage // Custom clean SMS text
      };
                          ...
                          <tr key={app.id} className="hover:bg-purple-50/30 transition">
                            ...
                            <td className="py-4 px-6 text-right">
                              <div className="flex items-center justify-end gap-2">
                                ...
                                {/* Call Interview SMS Button (Visible when SHORTLISTED) */}
                                {app.status === 'SHORTLISTED' && (
                                  <button
                                    type="button"
