      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200/80 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-purple-100 text-purple-700 font-bold text-xl rounded-xl flex items-center justify-center uppercase shadow-inner">
              {user?.name ? user.name[0] : 'E'}
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold text-slate-800">{user?.name || 'Employer'}</h1>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Link
              to="/create-job"
              className="flex-1 md:flex-initial text-center px-5 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-medium text-sm rounded-xl transition-all shadow-sm hover:shadow-md"
            >
              + Post New Job
            </Link>
            <button
              onClick={handleLogout}
              className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition"
            >
              Logout
            </button>
          </div>
