...
<div className="relative" ref={dropdownRef}>
  <button
    ...
    className="flex flex-col items-center gap-1.5 p-2 px-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-2xl transition focus:outline-none"
  >
    {/* Profile Image/Avatar (Top) */}
    <div className="w-10 h-10 rounded-full bg-purple-600 text-white font-extrabold text-sm flex items-center justify-center border-2 border-white shadow-sm overflow-hidden shrink-0">
      {user?.avatar ? (
  ...
  {/* Dropdown Menu */}
  {isDropdownOpen && (
    <div className="absolute right-0 mt-2 w-56 bg-white  py-2 z-50">
