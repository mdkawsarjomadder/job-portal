...
export default function ApplicantDashboard() {
  ...
  const [selectedJob, setSelectedJob] = useState(null); // যে জবে অ্যাপ্লাই করা হচ্ছে
  const [resumeFile, setResumeFile] = useState(null);   // সিলেক্ট করা ফাইল
  const [isModalOpen, setIsModalOpen] = useState(false); // ডাল ওপেন/ক্লোজ স্টেটমো
...
// ২. ফাইলসহ ফর্ম সাবমিট করার ফাংশন (FormData ব্যবহার করে)
const handleFormSubmit = async (e) => {
  ...
  formData.append('resume', resumeFile); // 'resume' ফিল্ড নেম ব্যাকএন্ডের Multer-এর সাথে মিল থাকতে হবে
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {activeTab === 'browse' ? (
          <div className="space-y-4">
            ...
            {/* 💡 এখানে jobs.length-এর বদলে filteredJobs ব্যবহার করা হয়েছে */}
            {filteredJobs.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* 💡 jobs.map এর জায়গায় filteredJobs.map ব্যবহার করা হয়েছে */}
