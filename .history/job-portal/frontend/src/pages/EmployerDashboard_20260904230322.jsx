  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 text-left font-sans">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* 🌟 New Colored Header / Navbar Section */}
        <div className="bg-gradient-to-r from-purple-900 via-indigo-800 to-purple-900 text-white p-6 rounded-2xl shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white font-medium text-sm rounded-xl border border-white/10 transition"
            >
              Logout
            </button>
          </div>
