          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-0.5">
              <div className="flex items-center gap-3">
                <h1 className="text-2xl font-bold text-white tracking-tight">{user?.name || 'Md Alish Islam'}</h1>
              ...
              <p className="text-xs font-medium text-purple-200/80">Employer Dashboard</p>
            </div>
          </div>
