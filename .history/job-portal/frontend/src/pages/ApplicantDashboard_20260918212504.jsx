      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-50 bg-white rounded-2xl shadow-2xl border border-gray-100 p-3 z-50 transform origin-top-right transition-all">
                {/* Header User Details */}
                <div className="flex items-center gap-3 p-2 border-b border-gray-100 mb-2">
                  <div className="w-9 h-10 rounded-full bg-purple-600 text-white font-bold text-sm flex items-center justify-center overflow-hidden shrink-0">
                    {user?.avatar ? (
                      <img 
                        src={user.avatar} 
                        alt={user.name} 
