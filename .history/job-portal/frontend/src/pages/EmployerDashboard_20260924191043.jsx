                    ...
                    {job.applications?.map((app) => {
                      ...
                      return (
                        <tr key={appId} className="hover:bg-slate-50 transition-colors divide-x divide-slate-200">
                          ...
                          {/* 2. EMAIL */}
                          <td className="py-3.5 px-4 text-slate-600 truncate font-semibol">
                          ...
                          <td className="py-3.5 px-4 text-center">
                            <select
                              ...
                              className="w-full max-w-[150px] px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer transition-all mx-auto"
                            >
