  ...
  <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4">
      <h3 className="text-lg font-bold text-slate-800 border-b pb-3">
        Call Interview for <span className="text-purple-600">{selectedApplicant?.applicant?.name || selectedApplicant?.applicantName}</span>
      </h3>

      <form onSubmit={handleSendInterviewCall} className="space-y-4">
        {/* Phone Input with manual override */}
        <div>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            ...
            className="flex-1 py-2.5 bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white font-medium rounded-xl text-sm shadow-sm"
          >
