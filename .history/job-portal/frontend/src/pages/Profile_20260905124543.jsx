...
export default function Profile() {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // 👈 বারবার সাবমিট আটকানোর জন্য
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (isSubmitting) return; // 👈 সাবমিট প্রসেসিং চলাকালে পুনরায় ক্লিক প্রতিরোধ
    ...
    try {
      ...
      // স্ক্রিনের ওপরে সাকসেস মেসেজ সেট
      setMessage({ type: 'success', text: 'Profile updated successfully!' });

      // ৩ সেকেন্ড পর টপ অ্যালার্ট অটোমেটিক হাওয়া হয়ে যাবে
      setTimeout(() => {
        setMessage({ type: '', text: '' });
      }, 3000);
    } catch (err) {
      ...
      setIsSubmitting(false); // 👈 রিকোয়েস্ট শেষ হলে বাটন আবার সক্রিয় হবে
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans text-left relative">
      ...
      {/* 🔴 Top-Floating Toast Alert (স্ক্রিনের একদম ওপরে ফ্লোট করবে) */}
      {message.text && (
      ...
      <div className="max-w-2xl mx-auto bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-200/80 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-sm">
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={isSubmitting} // 👈 সাবমিটিং চলাকালে বাটন ডিজেবল থাকবে
