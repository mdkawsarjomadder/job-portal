...
export const updateApplicationStatus = async (req, res) => {
  try {
    ...
    // FIX 1: updateApplicationStatus পরিবর্তন করে updatedApplication ব্যবহার করা হয়েছে
...
// ৭. Schedule Interview & Send SMS Controller
export const scheduleInterview = async (req, res) => {
  try {
    const { phone, phoneNumber, message, date, time, locationOrLink, jobTitle, applicantName } = req.body;

    // FIX 2: phone অথবা phoneNumber এর যেকোনো একটি গ্রহণযোগ্য
